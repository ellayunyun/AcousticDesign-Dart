...
["PanelEditor", "PanelEditor.dart", , M, {
  "^": "",
  BackgroundScaler: {
    "^": "Object;_scaling,_canvas,_image,_ctx,_start,_end,_template,_bubble,_numberInput,_callback",
    _callback$1$scale: function(arg0) {
      return this._callback.call$1$scale(arg0);
    },
    _draw$1: [function(time) {
      var t1, t2, t3, vector, t4, t5;
      t1 = this._ctx;
      t2 = this._image;
      J.drawImageScaledFromSource$9$x(t1, t2, 0, 0, J.get$width$x(t2), J.get$height$x(this._image), 0, 0, J.get$width$x(this._canvas), J.get$height$x(this._canvas));
      if (this._bubble != null) {
        t1 = this._ctx;
        J.set$fillStyle$x(t1, "rgba(0, 0, 0, .3)");
      ...
      if (t1 != null && this._end != null) {
        t1 = t1.get$y(t1);
        t2 = this._end;
        t2 = J.$sub$n(t1, t2.get$y(t2));
        t1 = this._start;
        t1 = t1.get$x(t1);
        t3 = this._end;
        vector = H.setRuntimeTypeInfo(new P.Point(t2, J.$negate$n(J.$sub$n(t1, t3.get$x(t3)))), [null]);
        t3 = vector.x;
        t1 = vector.y;
        t1 = J.$add$ns(J.$mul$ns(t3, t3), J.$mul$ns(t1, t1));
        if (typeof t1 !== "number")
          H.throwExpression(P.ArgumentError$(t1));
        vector = vector.$mul(0, 1 / Math.sqrt(t1)).$mul(0, 10);
        t1 = this._ctx;
        J.set$strokeStyle$x(t1, "#ff0000");
        t1.shadowBlur = 8;
        t1.shadowColor = "rgba(0, 0, 0, .7)";
        t1.lineWidth = 4;
        t1.beginPath();
        t2 = this._start;
        t2 = t2.get$x(t2);
        t3 = this._start;
        t1.moveTo(t2, t3.get$y(t3));
        t3 = this._end;
        t3 = t3.get$x(t3);
        t2 = this._end;
        t1.lineTo(t3, t2.get$y(t2));
        t2 = this._start;
        t3 = vector.x;
        t2 = J.$sub$n(t2.get$x(t2), t3);
        t4 = this._start;
        t5 = vector.y;
        t1.moveTo(t2, J.$sub$n(t4.get$y(t4), t5));
        t4 = this._start;
        t4 = J.$add$ns(t4.get$x(t4), t3);
        t2 = this._start;
        t1.lineTo(t4, J.$add$ns(t2.get$y(t2), t5));
        t2 = this._end;
        t2 = J.$sub$n(t2.get$x(t2), t3);
        t4 = this._end;
        t1.moveTo(t2, J.$sub$n(t4.get$y(t4), t5));
        t4 = this._end;
        t3 = J.$add$ns(t4.get$x(t4), t3);
        t4 = this._end;
        t1.lineTo(t3, J.$add$ns(t4.get$y(t4), t5));
        t1.stroke();
      }
      t1 = window;
      t2 = this.get$_draw();
    ...
    }, "call$1", "get$_draw", 2, 0, 9],
    _startScaling$1: [function($event) {
      var t1;
      this._scaling = true;
      this._start = J.get$offset$x($event);
      this._end = null;
      t1 = this._bubble;
      if (t1 != null) {
        J.remove$0$ax(t1);
    ...
    }, "call$1", "get$_startScaling", 2, 0, 10],
    _scale$1: [function($event) {
      if (!this._scaling)
        return;
      this._end = J.get$offset$x($event);
    }, "call$1", "get$_scale", 2, 0, 10],
    _stopScaling$1: [function($event) {
      var t1, t2, p, numberInput, submitInput, t3, form, bubble;
      this._scaling = false;
      t1 = J.get$offset$x($event);
      this._end = t1;
      if (J.$eq(t1, this._start))
        return;
      t1 = this._template;
      t2 = this.get$_bindTemplate();
      t1.toString;
      p = document.createElement("p", null);
      p.textContent = "Quelle est la taille r\u00e9elle en centim\u00e8tres de ce segment ?";
      numberInput = W.InputElement_InputElement(null);
      J.set$type$x(numberInput, "number");
      submitInput = W.InputElement_InputElement(null);
      t3 = J.getInterceptor$x(submitInput);
      t3.set$type(submitInput, "submit");
      t3.set$value(submitInput, "Valider");
      form = document.createElement("form", null);
      form.appendChild(p);
      form.appendChild(numberInput);
      form.appendChild(submitInput);
      bubble = document.createElement("div", null);
      bubble.className = "scaling-bubble";
      bubble.appendChild(form);
      t1._parent._container.appendChild(bubble);
      J.set$marginLeft$x(bubble.style, "" + -C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(bubble.offsetWidth)) / 2 + "px");
      numberInput.focus();
      t2.call$4$bubble$form$numberInput$submitInput(bubble, form, numberInput, submitInput);
    }, "call$1", "get$_stopScaling", 2, 0, 10],
    _bindTemplate$4$bubble$form$numberInput$submitInput: [function(bubble, form, numberInput, submitInput) {
      var t1, t2;
      t1 = {};
      t1.scale_0 = null;
      t1.number_1 = null;
      this._bubble = bubble;
      t2 = J.get$onSubmit$x(form);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new M.BackgroundScaler__bindTemplate_closure(t1, this, numberInput)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
    }, function() {
      return this._bindTemplate$4$bubble$form$numberInput$submitInput(null, null, null, null);
    }, "_bindTemplate$0", "call$4$bubble$form$numberInput$submitInput", "call$0", "get$_bindTemplate", 0, 9, 11, 12, 12, 12, 12],
    BackgroundScaler$4$callback$canvas$image$template: function(callback, canvas, image, template) {
      var t1, t2, t3;
      ...
      canvas.toString;
      t1 = C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(canvas.offsetWidth));
      t2 = J.get$width$x(this._image);
      if (typeof t2 !== "number")
        return H.iae(t2);
      J.set$height$x(this._canvas.style, C.JSInt_methods.toString$0(J.toInt$0$n(J.$mul$ns(J.get$height$x(this._image), t1 / t2))) + "px");
      this._scaling = false;
      this._ctx = J.getContext$1$x(this._canvas, "2d");
      t2 = this._canvas;
      t1 = J.getInterceptor$x(t2);
      t3 = t1.get$onMouseDown(t2);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t3._target, t3._eventType, W._wrapZone(this.get$_startScaling()), t3._useCapture), [H.getTypeArgumentByIndex(t3, 0)])._tryResume$0();
      t3 = t1.get$onMouseUp(t2);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t3._target, t3._eventType, W._wrapZone(this.get$_stopScaling()), t3._useCapture), [H.getTypeArgumentByIndex(t3, 0)])._tryResume$0();
      t3 = t1.get$onMouseMove(t2);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t3._target, t3._eventType, W._wrapZone(this.get$_scale()), t3._useCapture), [H.getTypeArgumentByIndex(t3, 0)])._tryResume$0();
      t3 = this._canvas;
      t3.toString;
      t1.set$width(t2, C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(t3.offsetWidth)));
      t3 = this._canvas;
      t3.toString;
      t1.set$height(t2, C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(t3.offsetHeight)));
      t3 = window;
      t2 = this.get$_draw();
  ...
  BackgroundScaler__bindTemplate_closure: {
    "^": "Closure:13;box_0,this_1,numberInput_2",
    call$1: function(e) {
      var number, t1, t2, t3, t4, scale;
      J.preventDefault$0$x(e);
      number = H.Primitives_parseInt(J.get$value$x(this.numberInput_2), null, null);
      t1 = this.box_0;
      t1.number_1 = number;
      if (J.$le$n(number, 0)) {
      ...
      t2 = this.this_1;
      t3 = t2._start.distanceTo$1(t2._end);
      t4 = t1.number_1;
      if (typeof t4 !== "number")
        return H.iae(t4);
      scale = t3 / t4;
      t1.scale_0 = scale;
      t2._callback$1$scale(scale);
    }
  },
  Editor: {
    "^": "Object;_scale,_background,_template,_leftContainer,_movingPanel,_movingImage,_resizingPanel,_panels,_patternName,_config,_groups,_skip",
    _addPanel$1: function(config) {
      var t1, panelConfig, t2, t3, t4, t5, t6, panel;
      t1 = J.getInterceptor$asx(config);
      panelConfig = J.$index$asx(J.$index$asx(this._config, "panels"), t1.$index(config, "name"));
      if (panelConfig == null)
        return;
      t2 = this._leftContainer;
      t3 = this._background;
      t4 = H.setRuntimeTypeInfo(new P.Point(J.$index$asx(t1.$index(config, "position"), "x"), J.$index$asx(t1.$index(config, "position"), "y")), [null]);
      t5 = J.getInterceptor$asx(panelConfig);
      t6 = t5.$index(panelConfig, "width");
      panel = new M.Panel(null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
      panel.Panel$8$container$editor$height$image$imagePosition$position$scale$width(t2, this, t5.$index(panelConfig, "height"), t3, H.setRuntimeTypeInfo(new P.Point(J.$index$asx(t1.$index(config, "imagePosition"), "x"), J.$index$asx(t1.$index(config, "imagePosition"), "y")), [null]), t4, this._scale, t6);
      this._panels.push(panel);
      return panel;
    },
    _onMouseUp$1: [function(e) {
      this._movingPanel = null;
      this._movingImage = null;
      this._resizingPanel = null;
    }, "call$1", "get$_onMouseUp", 2, 0, 10],
    _onMouseMove$1: [function(e) {
      var t1, t2, t3, config, newWidth, newHeight, t4, t5, t6;
      t1 = this._movingPanel;
      if (t1 != null) {
        t2 = J.getInterceptor$x(e);
        if (t1._solo) {
          t2 = t2.get$movement(e);
          t3 = H.setRuntimeTypeInfo(new P.Point(e.webkitMovementX, e.webkitMovementY), [null]);
          t1.move$2(J.$add$ns(t1._PanelEditor0$_position.x, t2.x), J.$add$ns(t1._PanelEditor0$_position.y, t3.y));
        } else
          this.moveGroup$2(t1._group, t2.get$movement(e));
      } else {
        t1 = this._movingImage;
        if (t1 != null) {
          t2 = J.getInterceptor$x(e);
          if (t1._solo)
            t1.moveImage$1(t2.get$movement(e));
          else
            this.moveGroupImage$2(t1._group, t2.get$movement(e));
        } else {
          t1 = this._resizingPanel;
          if (t1 != null) {
            t2 = J.get$movement$x(e);
            config = J.$index$asx(t1._editor._config, "panel");
            newWidth = J.$add$ns(J.get$width$x(t1._panel), t2.x);
            newHeight = J.$add$ns(J.get$height$x(t1._panel), t2.y);
            t2 = t1._scale;
            if (typeof newWidth !== "number")
              return newWidth.$tdiv();
            if (typeof t2 !== "number")
              return H.iae(t2);
            t3 = C.JSNumber_methods.$tdiv(newWidth, t2);
            if (typeof newHeight !== "number")
              return newHeight.$tdiv();
            t2 = C.JSNumber_methods.$tdiv(newHeight, t2);
            t4 = J.getInterceptor$asx(config);
            t5 = t4.$index(config, "min_width");
            if (typeof t5 !== "number")
              return H.iae(t5);
            if (t3 >= t5) {
              t5 = t4.$index(config, "max_width");
              if (typeof t5 !== "number")
                return H.iae(t5);
              if (t3 <= t5) {
                t5 = J.get$left$x(t1._panelWrapper.style);
                t5.toString;
                t5 = J.$add$ns(H.Primitives_parseInt(H.stringReplaceAllUnchecked(t5, "px", ""), null, null), newWidth);
                t6 = t1._editor._leftContainer;
                t6.toString;
                t6 = J.$lt$n(t5, C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(t6.clientWidth)));
                t5 = t6;
              } else
                t5 = false;
            } else
              t5 = false;
            if (t5)
              J.set$width$x(t1._panel, newWidth);
            t5 = t4.$index(config, "min_height");
            if (typeof t5 !== "number")
              return H.iae(t5);
            if (t2 >= t5) {
              t4 = t4.$index(config, "max_height");
              if (typeof t4 !== "number")
                return H.iae(t4);
              if (t2 <= t4) {
                t4 = J.get$top$x(t1._panelWrapper.style);
                t4.toString;
                t4 = J.$add$ns(H.Primitives_parseInt(H.stringReplaceAllUnchecked(t4, "px", ""), null, null), newHeight);
                t5 = t1._editor._leftContainer;
                t5.toString;
                t5 = J.$lt$n(t4, C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(t5.clientHeight)));
                t4 = t5;
              } else
                t4 = false;
            } else
              t4 = false;
            if (t4)
              J.set$height$x(t1._panel, newHeight);
            t1._widthDimension.textContent = C.JSNumber_methods.toString$0(t3) + " cm";
            t1._heightDimension.textContent = C.JSNumber_methods.toString$0(t2) + " cm";
          }
        }
      }
    }, "call$1", "get$_onMouseMove", 2, 0, 10],
    scaleGroupImages$2: function(group, e) {
      H.IterableMixinWorkaround_forEach(group._panels, new M.Editor_scaleGroupImages_closure(e));
    },
    moveGroup$2: function(group, delta) {
      H.IterableMixinWorkaround_forEach(group._panels, new M.Editor_moveGroup_closure(delta));
    },
    moveGroupImage$2: function(group, delta) {
      H.IterableMixinWorkaround_forEach(group._panels, new M.Editor_moveGroupImage_closure(delta));
    },
    changeGroupImage$2: function(group, image) {
      H.IterableMixinWorkaround_forEach(group._panels, new M.Editor_changeGroupImage_closure(image));
    },
    changeBackground$1: function(panel) {
      var t1 = {};
      t1.el_0 = null;
      t1.images_1 = null;
      W.HttpRequest_getString("gallery.html", null, null).then$1(new M.Editor_changeBackground_closure(t1, this, panel));
    },
    _configureTemplate$1$leftContainer: [function(leftContainer) {
      var t1, t2;
      this._leftContainer = leftContainer;
      t1 = this._background;
      if (t1 != null)
        J.set$backgroundImage$x(leftContainer.style, "url(" + H.S(J.get$src$x(t1)) + ")");
      if (this._patternName != null && J.$index$asx(J.$index$asx(this._config, "sets"), this._patternName) != null)
        this._createPanels$1(J.$index$asx(J.$index$asx(this._config, "sets"), this._patternName));
      t1 = window;
      t2 = this.get$_draw();
      C.Window_methods._ensureRequestAnimationFrame$0(t1);
      C.Window_methods._requestAnimationFrame$1(t1, W._wrapZone(t2));
    }, function() {
      return this._configureTemplate$1$leftContainer(null);
    }, "_configureTemplate$0", "call$1$leftContainer", "call$0", "get$_configureTemplate", 0, 3, 14, 12],
    _createPanels$1: function(config) {
      var t1, panels, group;
      t1 = {};
      t1.panel_0 = null;
      t1.group_1 = null;
      panels = J.$index$asx(config, "panels");
      group = new M.Group(null, "red");
      group._panels = H.setRuntimeTypeInfo([], [M.Panel]);
      t1.group_1 = group;
      J.forEach$1$ax(panels, new M.Editor__createPanels_closure(t1, this));
    },
    _draw$1: [function(time) {
      var t1, t2;
      H.IterableMixinWorkaround_forEach(this._panels, new M.Editor__draw_closure(time));
      t1 = window;
      t2 = this.get$_draw();
      C.Window_methods._ensureRequestAnimationFrame$0(t1);
      C.Window_methods._requestAnimationFrame$1(t1, W._wrapZone(t2));
    }, "call$1", "get$_draw", 2, 0, 9],
    Editor$4$background$config$scale$template: function(background, config, scale, template) {
      var t1, t2;
      this._skip = false;
      this._config = config;
      this._scale = scale;
      ...
      this._movingPanel = null;
      this._movingImage = null;
      this._panels = H.setRuntimeTypeInfo([], [M.Panel]);
      this._groups = H.setRuntimeTypeInfo([], [M.Group]);
      if (!this._skip)
        this._template.showPatternSelection$1$buttonAction(new M.Editor_closure(this));
      t1 = document;
      t2 = C.EventStreamProvider_mousemove.forTarget$1(t1);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(this.get$_onMouseMove()), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t1 = C.EventStreamProvider_mouseup.forTarget$1(t1);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(this.get$_onMouseUp()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      if (this._skip) {
        this._patternName = "monoptych";
        this._template.showEditor$1$callback(this.get$_configureTemplate());
      }
    },
    static: {"^": "Editor__scaleDelta", Editor$: function(background, config, scale, template) {
        var t1 = new M.Editor(null, null, null, null, null, null, null, null, null, null, null, null);
        t1.Editor$4$background$config$scale$template(background, config, scale, template);
        return t1;
      }}
  },
  Editor_closure: {
    "^": "Closure:0;this_0",
    call$1: function(patternName) {
      var t1 = this.this_0;
      t1._patternName = patternName;
      t1._template.showEditor$1$callback(t1.get$_configureTemplate());
    }
  },
  Editor_scaleGroupImages_closure: {
    "^": "Closure:15;e_0",
    call$1: function(panel) {
      panel.scaleImage$1(this.e_0);
    }
  },
  Editor_moveGroup_closure: {
    "^": "Closure:15;delta_0",
    call$1: function(panel) {
      var t1 = this.delta_0;
      J.moveBy$2$x(panel, t1.x, t1.y);
    }
  },
  Editor_moveGroupImage_closure: {
    "^": "Closure:15;delta_0",
    call$1: function(panel) {
      panel.moveImage$1(this.delta_0);
    }
  },
  Editor_changeGroupImage_closure: {
    "^": "Closure:15;image_0",
    call$1: function(panel) {
      panel.set$image(this.image_0);
    }
  },
  Editor_changeBackground_closure: {
    "^": "Closure:0;box_0,this_1,panel_2",
    call$1: function(data) {
      var el, t1, images, t2;
      el = W.Element_Element$html(data, null, null);
      t1 = this.box_0;
      t1.el_0 = el;
      images = J.querySelectorAll$1$x(el, ".gallery-thumb");
      t1.images_1 = images;
      images.forEach$1(images, new M.Editor_changeBackground__closure(t1, this.this_1, this.panel_2));
      t2 = document.getElementsByTagName("body");
      if (0 >= t2.length)
        return H.ioore(t2, 0);
      t2[0].appendChild(t1.el_0);
    }
  },
  Editor_changeBackground__closure: {
    "^": "Closure:16;box_0,this_3,panel_4",
    call$1: function(image) {
      var t1 = J.get$onClick$x(image);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new M.Editor_changeBackground___closure(this.box_0, this.this_3, this.panel_4, image)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    }
  },
  Editor_changeBackground___closure: {
    "^": "Closure:17;box_0,this_5,panel_6,image_7",
    call$1: function(_) {
      this.this_5.changeGroupImage$2(this.panel_6._group, this.image_7);
      J.remove$0$ax(this.box_0.el_0);
    }
  },
  Editor__createPanels_closure: {
    "^": "Closure:18;box_0,this_1",
    call$1: function(panelConfig) {
      var panel, t1;
      panel = this.this_1._addPanel$1(panelConfig);
      t1 = this.box_0;
      t1.panel_0 = panel;
      t1 = t1.group_1;
      t1.toString;
      if (panel != null && !C.JSArray_methods.contains$1(t1._panels, panel)) {
        t1._panels.push(panel);
        panel._group = t1;
        J.set$backgroundColor$x(panel._moveButton.style, t1._color);
      }
    }
  },
  Editor__draw_closure: {
    "^": "Closure:15;time_0",
    call$1: function(panel) {
      panel.draw$1(this.time_0);
    }
  },
  Group: {
    "^": "Object;_panels,_color"
  },
  Panel: {
    "^": "Object;_editor,_panel,_panelWrapper,_container,_moveButton,_soloButton,_backgroundButton,_resizeButton,_widthDimension,_heightDimension,_imagePosition,_scale,_imageScale,_PanelEditor0$_position,_width,_height,_image,_ctx,_linkedPanels,_group,_solo",
    _bind$0: function() {
      var t1, t2, t3;
      t1 = J.get$onMouseDown$x(this._moveButton);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new M.Panel__bind_closure(this)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      t1 = J.get$onClick$x(this._backgroundButton);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new M.Panel__bind_closure0(this)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      t1 = J.get$onClick$x(this._soloButton);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new M.Panel__bind_closure1(this)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      t1 = J.get$onMouseDown$x(this._resizeButton);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new M.Panel__bind_closure2(this)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      t1 = this._panel;
      t2 = J.getInterceptor$x(t1);
      t3 = t2.get$onMouseDown(t1);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t3._target, t3._eventType, W._wrapZone(new M.Panel__bind_closure3(this)), t3._useCapture), [H.getTypeArgumentByIndex(t3, 0)])._tryResume$0();
      t1 = t2.get$onMouseWheel(t1);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new M.Panel__bind_closure4(this)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    },
    scaleImage$1: function(e) {
      var t1, t2, t3, newScale;
      t1 = J.get$deltaY$x(e);
      if (typeof t1 !== "number")
        return t1.$lt();
      t2 = this._imageScale;
      ...
      this._imageScale = newScale;
      this.moveImage$1(H.setRuntimeTypeInfo(new P.Point(0, 0), [null]));
    },
    moveImage$1: function(delta) {
      var t1, t2, t3, x, y;
      t1 = this._imagePosition;
      t2 = delta.x;
      t3 = this._imageScale;
      if (typeof t2 !== "number")
        return t2.$div();
      x = J.toInt$0$n(J.$add$ns(t1.x, t2 / t3));
      t3 = this._imagePosition;
      t2 = delta.y;
      t1 = this._imageScale;
      if (typeof t2 !== "number")
        return t2.$div();
      y = J.toInt$0$n(J.$add$ns(t3.y, t2 / t1));
      this._imagePosition = H.setRuntimeTypeInfo(new P.Point(P.min(x, 0), P.min(y, 0)), [null]);
    },
    move$2: function(x, y) {
      var t1, t2;
      x = P.max(x, 0);
      y = P.max(y, 0);
      t1 = this._panelWrapper;
      t1.toString;
      t1 = C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(t1.offsetWidth));
      t2 = this._container;
      t2.toString;
      if (x + t1 > C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(t2.offsetWidth))) {
        t1 = this._container;
        t1.toString;
        t1 = C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(t1.offsetWidth));
        t2 = this._panelWrapper;
        t2.toString;
        x = t1 - C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(t2.offsetWidth));
      }
      t1 = this._panelWrapper;
      t1.toString;
      ...
      t2 = this._container;
      t2.toString;
      if (y + t1 > C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(t2.offsetHeight))) {
        t1 = this._container;
        t1.toString;
        t1 = C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(t1.offsetHeight));
        t2 = this._panelWrapper;
        t2.toString;
        y = t1 - C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(t2.offsetHeight));
      }
      t1 = H.setRuntimeTypeInfo(new P.Point(x, y), [null]);
      this._PanelEditor0$_position = t1;
      t2 = this._panelWrapper.style;
      J.getInterceptor$x(t2).set$left(t2, H.S(t1.x) + "px");
      C.CssStyleDeclaration_methods.set$top(t2, H.S(this._PanelEditor0$_position.y) + "px");
    },
    moveBy$2: function(_, x, y) {
      this.move$2(J.$add$ns(this._PanelEditor0$_position.x, x), J.$add$ns(this._PanelEditor0$_position.y, y));
    },
    draw$1: function(time) {
      ...
      if (this._image == null)
        return;
      t1 = this._ctx;
      J.fillRect$4$x(t1, 0, 0, J.get$width$x(this._panel), J.get$height$x(this._panel));
      t1.drawImage(this._image, J.$mul$ns(J.$negate$n(this._imagePosition.x), this._imageScale), J.$mul$ns(J.$negate$n(this._imagePosition.y), this._imageScale), J.get$width$x(this._image), J.get$height$x(this._image), 0, 0, J.$mul$ns(J.get$width$x(this._image), this._imageScale), J.$mul$ns(J.get$height$x(this._image), this._imageScale));
    },
    set$image: function(image) {
      this._image = image;
      return image;
    },
    Panel$8$container$editor$height$image$imagePosition$position$scale$width: function(container, editor, height, image, imagePosition, position, scale, width) {
      var t1, t2;
      this._editor = editor;
      if (container != null)
        this._container = container;
      this._PanelEditor0$_position = position;
      this._width = width;
      this._height = height;
      this._image = image;
      ...
      this._imageScale = 1;
      this._scale = scale;
      this._linkedPanels = H.setRuntimeTypeInfo([], [M.Panel]);
      this._solo = false;
      ...
      t1.className = "move";
      J.set$title$x(t1, "Move");
      this._moveButton = t1;
      t1 = document.createElement("div", null);
      t1.className = "solo";
      t1.textContent = "S";
      J.set$title$x(t1, "Solo");
      this._soloButton = t1;
      t1 = document.createElement("div", null);
      t1.className = "background";
      t1.textContent = "B";
      J.set$title$x(t1, "Background");
      this._backgroundButton = t1;
      t1 = document.createElement("div", null);
      t1.className = "resize";
      t1.textContent = "R";
      J.set$title$x(t1, "Resize");
      this._resizeButton = t1;
      t1 = document.createElement("div", null);
      t1.className = "dimension-width";
      t1.textContent = J.$add$ns(J.toString$0(this._width), " cm");
      this._widthDimension = t1;
      t1 = document.createElement("div", null);
      t1.className = "dimension-height";
      t1.textContent = J.$add$ns(J.toString$0(this._height), " cm");
      this._heightDimension = t1;
      t1 = document.createElement("div", null);
      t1.className = "panel-wrapper";
      t1.appendChild(this._panel);
      t1.appendChild(this._moveButton);
      t1.appendChild(this._backgroundButton);
      t1.appendChild(this._soloButton);
      t1.appendChild(this._resizeButton);
      t1.appendChild(this._widthDimension);
      t1.appendChild(this._heightDimension);
      this._panelWrapper = t1;
      this._container.appendChild(t1);
      t1 = this._panel;
      t2 = J.getInterceptor$x(t1);
      t2.set$width(t1, J.toInt$0$n(J.$mul$ns(this._width, this._editor._scale)));
      t2.set$height(t1, J.toInt$0$n(J.$mul$ns(this._height, this._editor._scale)));
      t1 = this._heightDimension.style;
      J.getInterceptor$x(t1).set$width(t1, J.toString$0(J.get$height$x(this._panel)) + "px");
      t2 = J.get$height$x(this._panel);
      if (typeof t2 !== "number")
        return t2.$negate();
      C.CssStyleDeclaration_methods.set$left(t1, C.JSNumber_methods.toString$0(-t2 / 2 - 10) + "px");
      this.move$2(J.$add$ns(this._PanelEditor0$_position.x, 0), J.$add$ns(this._PanelEditor0$_position.y, 0));
      this.moveImage$1(H.setRuntimeTypeInfo(new P.Point(0, 0), [null]));
      this._bind$0();
      this._ctx = J.getContext$1$x(this._panel, "2d");
      P.print(this._imagePosition.x);
    },
    static: {"^": "Panel__patterns"}
  },
  Panel__bind_closure: {
    "^": "Closure:19;this_0",
    call$1: function(e) {
      var t1 = this.this_0;
      if (J.$eq(J.get$target$x(e), t1._moveButton))
        t1._editor._movingPanel = t1;
    }
  },
  Panel__bind_closure0: {
    "^": "Closure:17;this_1",
    call$1: function(_) {
      var t1 = this.this_1;
      return t1._editor.changeBackground$1(t1);
    }
  },
  Panel__bind_closure1: {
    "^": "Closure:17;this_2",
    call$1: function(_) {
      var t1 = this.this_2;
      t1._solo = !t1._solo;
      J.get$classes$x(t1._soloButton).toggle$1("active");
      return;
    }
  },
  Panel__bind_closure2: {
    "^": "Closure:17;this_3",
    call$1: function(_) {
      var t1 = this.this_3;
      t1._editor._resizingPanel = t1;
    }
  },
  Panel__bind_closure3: {
    "^": "Closure:17;this_4",
    call$1: function(_) {
      var t1 = this.this_4;
      t1._editor._movingImage = t1;
      return t1;
    }
  },
  Panel__bind_closure4: {
    "^": "Closure:20;this_5",
    call$1: function(e) {
      var t1 = this.this_5;
      if (t1._solo)
        ...
        t1._editor.scaleGroupImages$2(t1._group, e);
    }
  },
  PanelEditor: {
    "^": "Object;_container,_backgroundImage,_template,_config,_skip",
    _launchEditor$1$scale: [function(scale) {
      var t1 = this._template;
      M.Editor$(this._backgroundImage, this._config, scale, t1);
    }, function() {
      return this._launchEditor$1$scale(null);
    }, "_launchEditor$0", "call$1$scale", "call$0", "get$_launchEditor", 0, 3, 21, 12],
    _loadBackground$1: function(file) {
      var t1, reader, t2;
      t1 = {};
      t1.reader_0 = null;
      if (!J.startsWith$1$s(file.type, "image")) {
        window.alert("Not an image");
        return;
      }
      reader = new FileReader();
      t2 = C.EventStreamProvider_load.forTarget$1(reader);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new M.PanelEditor__loadBackground_closure(t1, this)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t1.reader_0 = reader;
      reader.readAsDataURL(file);
    },
    PanelEditor$0: function() {
      var t1, t2, t3;
      this._skip = false;
      t1 = W.HttpRequest_getString("config.json", null, null);
      t1.then$1(new M.PanelEditor_closure(this));
      t2 = $.Zone__current;
      t3 = P._registerErrorHandler(new M.PanelEditor_closure0(), t2);
      t2.toString;
      t1._addListener$1(H.setRuntimeTypeInfo(new P._Future(0, t2, null, null, null, null, t3, null), [null]));
      t3 = J.get$onClick$x(document.getElementById("reload"));
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t3._target, t3._eventType, W._wrapZone(new M.PanelEditor_closure1()), t3._useCapture), [H.getTypeArgumentByIndex(t3, 0)])._tryResume$0();
    },
    static: {PanelEditor$: function() {
        var t1 = new M.PanelEditor(null, null, null, null, null);
        t1.PanelEditor$0();
        return t1;
      }}
  },
  PanelEditor_closure: {
    ...
    call$1: function(data) {
      var t1 = this.this_0;
      t1._config = C.JsonCodec_null_null.decode$1(data);
      t1._template = new M.Template(t1);
      t1._container = document.getElementById("editor");
      t1._template.showBackgroundUpload$2$fileHandler$skipHandler(new M.PanelEditor__closure(t1), new M.PanelEditor__closure0());
    }
  },
  PanelEditor__closure: {
    "^": "Closure:22;this_1",
    call$1: function(fileInput) {
      var t1 = J.getInterceptor$x(fileInput);
      if (t1.get$files(fileInput).length === 1) {
        t1 = t1.get$files(fileInput);
        if (0 >= t1.length)
          return H.ioore(t1, 0);
        this.this_1._loadBackground$1(t1[0]);
      }
    }
  },
  PanelEditor__closure0: {
    "^": "Closure:23;",
    call$0: function() {
      return new M.PanelEditor___closure();
    }
  },
  PanelEditor___closure: {
    "^": "Closure:23;",
    call$0: function() {
    }
  },
  PanelEditor_closure0: {
    "^": "Closure:17;",
    call$1: function(error) {
      window.alert(error);
    }
  },
  PanelEditor_closure1: {
    "^": "Closure:17;",
    call$1: function(_) {
      window.location.assign(window.location.href);
    }
  },
  PanelEditor__loadBackground_closure: {
    "^": "Closure:17;box_0,this_1",
    call$1: function(_) {
      var t1, t2, e, t3, canvas;
      t1 = this.this_1;
      t2 = J.get$result$x(this.box_0.reader_0);
      e = document.createElement("img", null);
      if (t2 != null)
        J.set$src$x(e, t2);
      t1._backgroundImage = e;
      t2 = t1._skip;
      t3 = t1._template;
      if (!t2) {
        canvas = t3.showBackgroundScaler$0();
        t2 = t1._template;
        t3 = t1._backgroundImage;
        new M.BackgroundScaler(null, null, null, null, null, null, null, null, null, null).BackgroundScaler$4$callback$canvas$image$template(t1.get$_launchEditor(), canvas, t3, t2);
      } else
        M.Editor$(e, t1._config, 1.64506838763621, t3);
    }
  },
  Template: {
    "^": "Object;_parent",
    showBackgroundUpload$2$fileHandler$skipHandler: function(fileHandler, skipHandler) {
      var t1, t2, fileInput, t3, skipButton;
      t1 = {};
      t1.fileInput_0 = null;
      t2 = this._parent;
      J._clearChildren$0$x(t2._container);
      fileInput = W.InputElement_InputElement(null);
      t3 = J.getInterceptor$x(fileInput);
      t3.set$type(fileInput, "file");
      t3 = t3.get$onChange(fileInput);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t3._target, t3._eventType, W._wrapZone(new M.Template_showBackgroundUpload_closure(t1, fileHandler)), t3._useCapture), [H.getTypeArgumentByIndex(t3, 0)])._tryResume$0();
      t1.fileInput_0 = fileInput;
      skipButton = document.createElement("button", null);
      skipButton.textContent = "Skip";
      t3 = J.get$onClick$x(skipButton);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t3._target, t3._eventType, W._wrapZone(new M.Template_showBackgroundUpload_closure0(skipHandler)), t3._useCapture), [H.getTypeArgumentByIndex(t3, 0)])._tryResume$0();
      t2._container.appendChild(t1.fileInput_0);
    },
    showBackgroundScaler$0: function() {
      var t1, canvas;
      t1 = this._parent;
      if (t1._backgroundImage == null)
        return;
      canvas = W.CanvasElement_CanvasElement(null, null);
      canvas.className = "background-scaler";
      J._clearChildren$0$x(t1._container);
      t1._container.appendChild(canvas);
      return canvas;
    },
    showEditor$1$callback: function(callback) {
      var leftContainer, t1;
      leftContainer = document.createElement("div", null);
      leftContainer.className = "container-left";
      t1 = this._parent;
      J._clearChildren$0$x(t1._container);
      t1._container.appendChild(leftContainer);
      callback.call$1$leftContainer(leftContainer);
    },
    showPatternSelection$1$buttonAction: function(buttonAction) {
      var button1, t1, button2;
      button1 = document.createElement("button", null);
      button1.textContent = "Panneau simple";
      t1 = J.get$onClick$x(button1);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new M.Template_showPatternSelection_closure(buttonAction)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      button2 = document.createElement("button", null);
      button2.textContent = "Dyptique";
      t1 = J.get$onClick$x(button2);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new M.Template_showPatternSelection_closure0(buttonAction)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      t1 = this._parent;
      J._clearChildren$0$x(t1._container);
      t1 = t1._container;
      t1.appendChild(button1);
      t1.appendChild(button2);
    }
  },
  Template_showBackgroundUpload_closure: {
    "^": "Closure:17;box_0,fileHandler_1",
    call$1: function(_) {
      return this.fileHandler_1.call$1(this.box_0.fileInput_0);
    }
  },
  Template_showBackgroundUpload_closure0: {
    "^": "Closure:17;skipHandler_2",
    call$1: function(_) {
      return this.skipHandler_2.call$0();
    }
  },
  Template_showPatternSelection_closure: {
    "^": "Closure:17;buttonAction_0",
    call$1: function(_) {
      var t1 = this.buttonAction_0;
      if (t1 != null)
        t1.call$1("monoptych");
    }
  },
  Template_showPatternSelection_closure0: {
    "^": "Closure:17;buttonAction_1",
    call$1: function(_) {
      var t1 = this.buttonAction_1;
      if (t1 != null)
        t1.call$1("diptych");
    }
  }
...
["dart.async", "dart:async", , P, {
  ...
  _AsyncCompleter: {
    ...
    }, "completeError$1", "call$2", "call$1", "get$completeError", 2, 2, 27, 12]
  },
  _Future: {
    ...
    }, "_completeError$1", "call$2", "call$1", "get$_completeError", 2, 2, 28, 12],
...
["dart.dom.html", "dart:html", , W, {
  ...
  CanvasRenderingContext2D: {
    "^": "CanvasRenderingContext;fillStyle},strokeStyle}",
  ...
  InputElement: {
    "^": "HtmlElement;files=,height%,name=,src%,type},value%,width%",
    $isElement: true,
    $isEventTarget: true,
    "%": "HTMLInputElement"
  },
...
["dart.math", "dart:math", , P, {
  ...
  Point: {
    ...
    distanceTo$1: function(other) {
      var dx, dy, t1;
      dx = J.$sub$n(this.x, other.get$x(other));
      dy = J.$sub$n(this.y, other.y);
...
J.moveBy$2$x = function(receiver, a0, a1) {
  return J.getInterceptor$x(receiver).moveBy$2(receiver, a0, a1);
};
...
{func: "void___DivElement_FormElement_InputElement_InputElement", void: true, named: {bubble: W.DivElement, form: W.FormElement, numberInput: W.InputElement, submitInput: W.InputElement}},
,
{func: "dynamic__Event", args: [W.Event]},
{func: "void___DivElement", void: true, named: {leftContainer: W.DivElement}},
{func: "dynamic__Panel", args: [M.Panel]},
...
{func: "void___double", void: true, named: {scale: P.$double}},
...
function dart_precompiled($collectedClasses) {
  ...
  function BackgroundScaler(_scaling, _canvas, _image, _ctx, _start, _end, _template, _bubble, _numberInput, _callback) {
    ...
    this._numberInput = _numberInput;
    this._callback = _callback;
  }
  BackgroundScaler.builtin$cls = "BackgroundScaler";
  if (!"name" in BackgroundScaler)
    BackgroundScaler.name = "BackgroundScaler";
  $desc = $collectedClasses.BackgroundScaler;
  if ($desc instanceof Array)
    $desc = $desc[1];
  BackgroundScaler.prototype = $desc;
  function BackgroundScaler__bindTemplate_closure(box_0, this_1, numberInput_2) {
    this.box_0 = box_0;
    this.this_1 = this_1;
    this.numberInput_2 = numberInput_2;
  }
  BackgroundScaler__bindTemplate_closure.builtin$cls = "BackgroundScaler__bindTemplate_closure";
  if (!"name" in BackgroundScaler__bindTemplate_closure)
    BackgroundScaler__bindTemplate_closure.name = "BackgroundScaler__bindTemplate_closure";
  $desc = $collectedClasses.BackgroundScaler__bindTemplate_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  BackgroundScaler__bindTemplate_closure.prototype = $desc;
  function Editor(_scale, _background, _template, _leftContainer, _movingPanel, _movingImage, _resizingPanel, _panels, _patternName, _config, _groups, _skip) {
    this._scale = _scale;
    this._background = _background;
    this._template = _template;
    this._leftContainer = _leftContainer;
    this._movingPanel = _movingPanel;
    this._movingImage = _movingImage;
    this._resizingPanel = _resizingPanel;
    this._panels = _panels;
    this._patternName = _patternName;
  ...
  function Editor_closure(this_0) {
    this.this_0 = this_0;
  }
  Editor_closure.builtin$cls = "Editor_closure";
  if (!"name" in Editor_closure)
    Editor_closure.name = "Editor_closure";
  $desc = $collectedClasses.Editor_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Editor_closure.prototype = $desc;
  function Editor_scaleGroupImages_closure(e_0) {
    this.e_0 = e_0;
  }
  Editor_scaleGroupImages_closure.builtin$cls = "Editor_scaleGroupImages_closure";
  if (!"name" in Editor_scaleGroupImages_closure)
    Editor_scaleGroupImages_closure.name = "Editor_scaleGroupImages_closure";
  $desc = $collectedClasses.Editor_scaleGroupImages_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Editor_scaleGroupImages_closure.prototype = $desc;
  function Editor_moveGroup_closure(delta_0) {
    this.delta_0 = delta_0;
  }
  Editor_moveGroup_closure.builtin$cls = "Editor_moveGroup_closure";
  if (!"name" in Editor_moveGroup_closure)
    Editor_moveGroup_closure.name = "Editor_moveGroup_closure";
  $desc = $collectedClasses.Editor_moveGroup_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Editor_moveGroup_closure.prototype = $desc;
  function Editor_moveGroupImage_closure(delta_0) {
    this.delta_0 = delta_0;
  }
  Editor_moveGroupImage_closure.builtin$cls = "Editor_moveGroupImage_closure";
  if (!"name" in Editor_moveGroupImage_closure)
    Editor_moveGroupImage_closure.name = "Editor_moveGroupImage_closure";
  $desc = $collectedClasses.Editor_moveGroupImage_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Editor_moveGroupImage_closure.prototype = $desc;
  function Editor_changeGroupImage_closure(image_0) {
    this.image_0 = image_0;
  }
  Editor_changeGroupImage_closure.builtin$cls = "Editor_changeGroupImage_closure";
  if (!"name" in Editor_changeGroupImage_closure)
    Editor_changeGroupImage_closure.name = "Editor_changeGroupImage_closure";
  $desc = $collectedClasses.Editor_changeGroupImage_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Editor_changeGroupImage_closure.prototype = $desc;
  function Editor_changeBackground_closure(box_0, this_1, panel_2) {
    this.box_0 = box_0;
    this.this_1 = this_1;
    this.panel_2 = panel_2;
  }
  Editor_changeBackground_closure.builtin$cls = "Editor_changeBackground_closure";
  if (!"name" in Editor_changeBackground_closure)
    Editor_changeBackground_closure.name = "Editor_changeBackground_closure";
  $desc = $collectedClasses.Editor_changeBackground_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Editor_changeBackground_closure.prototype = $desc;
  function Editor_changeBackground__closure(box_0, this_3, panel_4) {
    this.box_0 = box_0;
    this.this_3 = this_3;
    this.panel_4 = panel_4;
  }
  Editor_changeBackground__closure.builtin$cls = "Editor_changeBackground__closure";
  if (!"name" in Editor_changeBackground__closure)
    Editor_changeBackground__closure.name = "Editor_changeBackground__closure";
  $desc = $collectedClasses.Editor_changeBackground__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Editor_changeBackground__closure.prototype = $desc;
  function Editor_changeBackground___closure(box_0, this_5, panel_6, image_7) {
    this.box_0 = box_0;
    this.this_5 = this_5;
    this.panel_6 = panel_6;
    this.image_7 = image_7;
  }
  Editor_changeBackground___closure.builtin$cls = "Editor_changeBackground___closure";
  if (!"name" in Editor_changeBackground___closure)
    Editor_changeBackground___closure.name = "Editor_changeBackground___closure";
  $desc = $collectedClasses.Editor_changeBackground___closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Editor_changeBackground___closure.prototype = $desc;
  function Editor__createPanels_closure(box_0, this_1) {
    this.box_0 = box_0;
    this.this_1 = this_1;
  }
  Editor__createPanels_closure.builtin$cls = "Editor__createPanels_closure";
  if (!"name" in Editor__createPanels_closure)
    Editor__createPanels_closure.name = "Editor__createPanels_closure";
  $desc = $collectedClasses.Editor__createPanels_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Editor__createPanels_closure.prototype = $desc;
  function Editor__draw_closure(time_0) {
    this.time_0 = time_0;
  }
  Editor__draw_closure.builtin$cls = "Editor__draw_closure";
  if (!"name" in Editor__draw_closure)
    Editor__draw_closure.name = "Editor__draw_closure";
  $desc = $collectedClasses.Editor__draw_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Editor__draw_closure.prototype = $desc;
  function Group(_panels, _color) {
    this._panels = _panels;
    this._color = _color;
  }
  ...
  function Panel(_editor, _panel, _panelWrapper, _container, _moveButton, _soloButton, _backgroundButton, _resizeButton, _widthDimension, _heightDimension, _imagePosition, _scale, _imageScale, _PanelEditor0$_position, _width, _height, _image, _ctx, _linkedPanels, _group, _solo) {
    this._editor = _editor;
    this._panel = _panel;
    this._panelWrapper = _panelWrapper;
    this._container = _container;
    this._moveButton = _moveButton;
    this._soloButton = _soloButton;
    this._backgroundButton = _backgroundButton;
    this._resizeButton = _resizeButton;
    this._widthDimension = _widthDimension;
    this._heightDimension = _heightDimension;
    this._imagePosition = _imagePosition;
    this._scale = _scale;
    this._imageScale = _imageScale;
    this._PanelEditor0$_position = _PanelEditor0$_position;
    this._width = _width;
    this._height = _height;
    this._image = _image;
    this._ctx = _ctx;
    this._linkedPanels = _linkedPanels;
    this._group = _group;
    this._solo = _solo;
  }
  ...
  function Panel__bind_closure(this_0) {
    this.this_0 = this_0;
  }
  Panel__bind_closure.builtin$cls = "Panel__bind_closure";
  if (!"name" in Panel__bind_closure)
    Panel__bind_closure.name = "Panel__bind_closure";
  $desc = $collectedClasses.Panel__bind_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Panel__bind_closure.prototype = $desc;
  function Panel__bind_closure0(this_1) {
    this.this_1 = this_1;
  }
  Panel__bind_closure0.builtin$cls = "Panel__bind_closure0";
  if (!"name" in Panel__bind_closure0)
    Panel__bind_closure0.name = "Panel__bind_closure0";
  $desc = $collectedClasses.Panel__bind_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Panel__bind_closure0.prototype = $desc;
  function Panel__bind_closure1(this_2) {
    this.this_2 = this_2;
  }
  Panel__bind_closure1.builtin$cls = "Panel__bind_closure1";
  if (!"name" in Panel__bind_closure1)
    Panel__bind_closure1.name = "Panel__bind_closure1";
  $desc = $collectedClasses.Panel__bind_closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Panel__bind_closure1.prototype = $desc;
  function Panel__bind_closure2(this_3) {
    this.this_3 = this_3;
  }
  Panel__bind_closure2.builtin$cls = "Panel__bind_closure2";
  if (!"name" in Panel__bind_closure2)
    Panel__bind_closure2.name = "Panel__bind_closure2";
  $desc = $collectedClasses.Panel__bind_closure2;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Panel__bind_closure2.prototype = $desc;
  function Panel__bind_closure3(this_4) {
    this.this_4 = this_4;
  }
  Panel__bind_closure3.builtin$cls = "Panel__bind_closure3";
  if (!"name" in Panel__bind_closure3)
    Panel__bind_closure3.name = "Panel__bind_closure3";
  $desc = $collectedClasses.Panel__bind_closure3;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Panel__bind_closure3.prototype = $desc;
  function Panel__bind_closure4(this_5) {
    this.this_5 = this_5;
  }
  Panel__bind_closure4.builtin$cls = "Panel__bind_closure4";
  if (!"name" in Panel__bind_closure4)
    Panel__bind_closure4.name = "Panel__bind_closure4";
  $desc = $collectedClasses.Panel__bind_closure4;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Panel__bind_closure4.prototype = $desc;
  function PanelEditor(_container, _backgroundImage, _template, _config, _skip) {
    this._container = _container;
  ...
  PanelEditor.builtin$cls = "PanelEditor";
  if (!"name" in PanelEditor)
    PanelEditor.name = "PanelEditor";
  $desc = $collectedClasses.PanelEditor;
  if ($desc instanceof Array)
    $desc = $desc[1];
  PanelEditor.prototype = $desc;
  function PanelEditor_closure(this_0) {
    this.this_0 = this_0;
  }
  PanelEditor_closure.builtin$cls = "PanelEditor_closure";
  if (!"name" in PanelEditor_closure)
    PanelEditor_closure.name = "PanelEditor_closure";
  $desc = $collectedClasses.PanelEditor_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  PanelEditor_closure.prototype = $desc;
  function PanelEditor__closure(this_1) {
    this.this_1 = this_1;
  }
  PanelEditor__closure.builtin$cls = "PanelEditor__closure";
  if (!"name" in PanelEditor__closure)
    PanelEditor__closure.name = "PanelEditor__closure";
  $desc = $collectedClasses.PanelEditor__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  PanelEditor__closure.prototype = $desc;
  function PanelEditor__closure0() {
  }
  PanelEditor__closure0.builtin$cls = "PanelEditor__closure0";
  if (!"name" in PanelEditor__closure0)
    PanelEditor__closure0.name = "PanelEditor__closure0";
  $desc = $collectedClasses.PanelEditor__closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  PanelEditor__closure0.prototype = $desc;
  function PanelEditor___closure() {
  }
  PanelEditor___closure.builtin$cls = "PanelEditor___closure";
  if (!"name" in PanelEditor___closure)
    PanelEditor___closure.name = "PanelEditor___closure";
  $desc = $collectedClasses.PanelEditor___closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  PanelEditor___closure.prototype = $desc;
  function PanelEditor_closure0() {
  }
  PanelEditor_closure0.builtin$cls = "PanelEditor_closure0";
  if (!"name" in PanelEditor_closure0)
    PanelEditor_closure0.name = "PanelEditor_closure0";
  $desc = $collectedClasses.PanelEditor_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  PanelEditor_closure0.prototype = $desc;
  function PanelEditor_closure1() {
  }
  PanelEditor_closure1.builtin$cls = "PanelEditor_closure1";
  if (!"name" in PanelEditor_closure1)
    PanelEditor_closure1.name = "PanelEditor_closure1";
  $desc = $collectedClasses.PanelEditor_closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  PanelEditor_closure1.prototype = $desc;
  function PanelEditor__loadBackground_closure(box_0, this_1) {
    this.box_0 = box_0;
    this.this_1 = this_1;
  }
  PanelEditor__loadBackground_closure.builtin$cls = "PanelEditor__loadBackground_closure";
  if (!"name" in PanelEditor__loadBackground_closure)
    PanelEditor__loadBackground_closure.name = "PanelEditor__loadBackground_closure";
  $desc = $collectedClasses.PanelEditor__loadBackground_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  PanelEditor__loadBackground_closure.prototype = $desc;
  function Template(_parent) {
  ...
  function Template_showBackgroundUpload_closure(box_0, fileHandler_1) {
    this.box_0 = box_0;
    this.fileHandler_1 = fileHandler_1;
  }
  Template_showBackgroundUpload_closure.builtin$cls = "Template_showBackgroundUpload_closure";
  if (!"name" in Template_showBackgroundUpload_closure)
    Template_showBackgroundUpload_closure.name = "Template_showBackgroundUpload_closure";
  $desc = $collectedClasses.Template_showBackgroundUpload_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Template_showBackgroundUpload_closure.prototype = $desc;
  function Template_showBackgroundUpload_closure0(skipHandler_2) {
    this.skipHandler_2 = skipHandler_2;
  }
  Template_showBackgroundUpload_closure0.builtin$cls = "Template_showBackgroundUpload_closure0";
  if (!"name" in Template_showBackgroundUpload_closure0)
    Template_showBackgroundUpload_closure0.name = "Template_showBackgroundUpload_closure0";
  $desc = $collectedClasses.Template_showBackgroundUpload_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Template_showBackgroundUpload_closure0.prototype = $desc;
  function Template_showPatternSelection_closure(buttonAction_0) {
    this.buttonAction_0 = buttonAction_0;
  }
  Template_showPatternSelection_closure.builtin$cls = "Template_showPatternSelection_closure";
  if (!"name" in Template_showPatternSelection_closure)
    Template_showPatternSelection_closure.name = "Template_showPatternSelection_closure";
  $desc = $collectedClasses.Template_showPatternSelection_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Template_showPatternSelection_closure.prototype = $desc;
  function Template_showPatternSelection_closure0(buttonAction_1) {
    this.buttonAction_1 = buttonAction_1;
  }
  Template_showPatternSelection_closure0.builtin$cls = "Template_showPatternSelection_closure0";
  if (!"name" in Template_showPatternSelection_closure0)
    Template_showPatternSelection_closure0.name = "Template_showPatternSelection_closure0";
  $desc = $collectedClasses.Template_showPatternSelection_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Template_showPatternSelection_closure0.prototype = $desc;
